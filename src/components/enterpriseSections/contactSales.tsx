            ...
            <div>
                <div className="container">
                    <div className='p-2 flex justify-between pt-[75px] pb-[75px] m-auto'>
                        ...
                        <div className={`form relative box-border z-10 flex flex-col items-start border shadow-[rgba(45,40,77,0.1)_0px_12px_32px] 
                p-8 rounded-lg border-solid border-[rgb(231,237,246)] ${storeTheme === "dark" ? 'bg-black text-white duration-300' : 'bg-[white]'}`}>
